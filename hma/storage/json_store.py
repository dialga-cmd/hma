"""
JSON storage for HMA Knowledge Maps.

Handles persisting the KnowledgeMap to a `.hma.json` file.
"""
...
from hma.core.models import KnowledgeMap
from hma.core.config import HMAConfig
from hma.core.exceptions import StorageError
...
class JSONStore:
    ...
    def __init__(self, filename: str = ".hma.json"):
