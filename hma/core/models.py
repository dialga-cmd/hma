"""
Data models for HMA Knowledge Maps.

These dataclasses define the structure of the Knowledge Map —
the central data structure that HMA uses to route queries to
...
class Relationship:
    ...
    Relationships are single-hop only — HMA tracks which files are
...
class KnowledgeMap:
    ...
    This is the central data structure in HMA. It contains:
    ...
    The Knowledge Map is persisted as .hma.json and used to route
    ...
    version: str = "0.1.0"
    """HMA version that created/updated this map."""
