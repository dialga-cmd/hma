"""
Query engine that orchestrates the HMA querying phase.
...
from hma.core.models import KnowledgeMap, Answer
from hma.core.config import HMAConfig
from hma.querying.router import Router
from hma.querying.reader import Reader
from hma.querying.traverser import Traverser


class QueryEngine:
    """Orchestrates the querying phase of HMA."""
